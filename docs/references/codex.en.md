...
| [`codex mcp add/list/get/remove`](https://developers.openai.com/codex/cli) | CLI management writing `config.toml` | ⚠️ `ganja mcp` lists; add/remove are config-file edits |
