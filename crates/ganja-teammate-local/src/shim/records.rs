...
//! outlive the process that started it. [`crate::reaper`] is the
...
//! ([`ShimFate`](crate::reaper::ShimFate)): such a file is swept but
//! never unlinked.
//!
...
//! that [`crate::reaper`]'s `argv_of` does not — the owner line is
...
/// [`sweep_file`](crate::reaper) decides it at its own
/// `read_to_string` arm.
...
///
/// Held by [`ganja_core::teammate::TeammateRegistry`] behind a
