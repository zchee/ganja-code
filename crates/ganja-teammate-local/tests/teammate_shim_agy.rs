...
//! [`ganja_teammate_local::agy::Agy`] itself — the launch line a real member is
...
use ganja_core::teammate::{BACKENDS, backend_name, parse_backend, posture_line};
use ganja_team::{MailboxMessage, MemberName, mailbox, record};
use ganja_teammate_local::agy::{self, Agy};
