...
//! for fuzzy-searching remembered prompts, the strip of messages waiting for
//! the running turn, and the two inline menus the editor raises — one on a
//! leading slash, one on an `@`.
