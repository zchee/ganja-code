...
- **These are verbatim upstream copies** from `packages/tui/src/theme/assets/` at v1.18.11. Do not reformat, re-indent, sort keys, or "fix" them — a byte diff against upstream must stay empty, because that is what the notices claim.
