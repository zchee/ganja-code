...
! cargo tree -p ganja-core -e normal | grep -qE 'prost|tonic'      # the cursor fence:
! cargo tree -p ganja-provider -e normal | grep -qE 'prost|tonic'  # gRPC in its own crate, or nowhere
